...
namespace borderless_windowless
{
    public partial class Main_Control : UserControl
    {
        ...
        {
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
            {
                Login_Control LC = new Login_Control();
                LC.Dock = DockStyle.Fill;
                Main_Form.Instance.Body_Panel_Container.Controls.Add(LC);
                

            }
            Main_Form.Instance.Body_Panel_Container.Controls["Login_Control"].BringToFront();           
        }
        ...
        private void Find_Repair_Button_Click(object sender, EventArgs e)
        {
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
            {
                ...
                Main_Form.Instance.Body_Panel_Container.Controls.Add(FRC);

            }
            Main_Form.Instance.Body_Panel_Container.Controls["Find_Rep_Control"].BringToFront();
        }
        ...
        private void Find_Customer_Button_Click(object sender, EventArgs e)
        {
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
            {
                ...
                Main_Form.Instance.Body_Panel_Container.Controls.Add(FUC);

            }
            Main_Form.Instance.Body_Panel_Container.Controls["Find_Customer_Control"].BringToFront();
        }
        ...
        private void Create_Repair_Button_Click(object sender, EventArgs e)
        {
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
            {
                ...
                Main_Form.Instance.Body_Panel_Container.Controls.Add(CR);

            }
            Main_Form.Instance.Body_Panel_Container.Controls["Create_Repair_Control"].BringToFront();
        ...
        private void Create_Customer_Button_Click(object sender, EventArgs e)
        {
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
            {
                ...
                Main_Form.Instance.Body_Panel_Container.Controls.Add(CU);

            }
            Main_Form.Instance.Body_Panel_Container.Controls["Create_User_Control"].BringToFront();
        }
           ...
           *
            ...
            * */
            ...
            if (!Main_Form.Instance.Body_Panel_Container.Controls.ContainsKey("Home_Control"))
                ...
                Main_Form.Instance.Body_Panel_Container.Controls.Add(VU);
                
                 }
            Main_Form.Instance.Body_Panel_Container.Controls["View_User_Control"].BringToFront();
